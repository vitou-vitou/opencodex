...
**ECC / gstack:** do not replace Superpowers. See [references/framework-best-used.md](references/framework-best-used.md) (Nebutra). ECC = cherry-pick `tdd-workflow` / `eval-harness` only; never full install on shared work.
