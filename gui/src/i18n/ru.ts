...
export const ru: Record<TKey, string> = {
  ...
  "ngrok.urlsTitle": "URL list",
  "ngrok.urlsHint": "Local proxy and public tunnel URLs. Copy any row.",
  "ngrok.localUrl": "Local URL",
  ...
  "ngrok.signUp": "Sign up",
  "ngrok.getToken": "Get token",
  "ngrok.saving": "Saving…",
