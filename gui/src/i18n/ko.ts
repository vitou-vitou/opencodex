...
export const ko: Record<TKey, string> = {
  ...
  "logs.filter.noMatches": "이 필터와 일치하는 요청이 없습니다.",
  ...
  "api.authLoopback": "루프백 바인드에서 로컬 Host 127.0.0.1 / localhost는 인증을 건너뜁니다. 공개 Host(ngrok 같은 터널)와 비루프백 바인드는 생성된 ocx_ 키 또는 OPENCODEX_API_AUTH_TOKEN이 필요합니다.",
  "api.authTunnelNgrok": "ngrok 무료 요금제에서는 API 클라이언트가 브라우저 중간 페이지를 건너뛰려면 ngrok-skip-browser-warning: 1도 보내야 합니다.",
  ...
  "api.testAll": "모두 테스트",
  "api.testingAll": "테스트 중 {done}/{total}…",
  ...
  "claude.ideHint": "Cursor IDE Claude Code 채팅: {cmd} 를 한 번 실행한 뒤 Claude 패널을 다시 로드하세요.",
  "claude.failoverDefault": "장애 조치 기본값",
  "claude.failoverDefaultDesc": "Claude Default/Opus를 순위 게이트웨이 체인 헤드로 바꿉니다. 실패 시에만 전환하며, 매 200마다 돌리지 않습니다.",
  "claude.failoverDefaultApply": "순위 기본값 적용",
  "claude.failoverDefaultOk": "장애 조치 기본값을 적용했습니다. Claude 패널을 다시 로드하세요.",
  "claude.failoverDefaultOkAlias": "장애 조치 기본값 적용 → {alias}. Claude 패널을 다시 로드하세요.",
  "claude.failoverDefaultFail": "장애 조치 기본값을 적용하지 못했습니다.",
