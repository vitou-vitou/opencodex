...
export const ja: Record<TKey, string> = {
  ...
  "api.authLoopback": "ループバック bind でのローカル Host 127.0.0.1 / localhost は認証を省略します。公開 Host（ngrok などのトンネル）と非ループバック bind では生成した ocx_ キーまたは OPENCODEX_API_AUTH_TOKEN が必要です。",
  "api.authTunnelNgrok": "ngrok 無料プランでは、API クライアントはブラウザの確認ページを避けるため ngrok-skip-browser-warning: 1 も送ってください。",
  ...
  "api.testAll": "すべてテスト",
  "api.testingAll": "テスト中 {done}/{total}…",
  ...
  "claude.ideHint": "Cursor IDE の Claude Code チャット: {cmd} を一度実行し、Claude パネルを再読み込みしてください。",
  "claude.failoverDefault": "フェイルオーバー Default",
  "claude.failoverDefaultDesc": "Claude の Default/Opus をランク付きゲートウェイ連鎖の先頭に差し替えます。失敗時のみホップし、毎回 200 では回りません。",
  "claude.failoverDefaultApply": "ランク Default を適用",
  "claude.failoverDefaultOk": "フェイルオーバー Default を適用しました。Claude パネルを再読み込みしてください。",
  "claude.failoverDefaultOkAlias": "フェイルオーバー Default を適用 → {alias}。Claude パネルを再読み込みしてください。",
  "claude.failoverDefaultFail": "フェイルオーバー Default を適用できませんでした。",
