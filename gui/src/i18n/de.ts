...
export const de: Record<TKey, string> = {
  ...
  "prov.openaiPoolDesc": "Standard. Ein Codex-Anfragepfad: wechselt mit Thread-Affinität, Kontingent, Abklingzeit und Ausfallsicherung zwischen Hauptanmeldung und hinzugefügten Konten — nicht N parallele Sitzungen.",
  ...
  "logs.filter.status.all": "Alle",
  "logs.filter.status.2xx": "2xx",
  "logs.filter.status.4xx": "4xx",
  "logs.filter.status.5xx": "5xx",
  "logs.filter.noMatches": "Keine Anfragen passen zu diesen Filtern.",
  ...
  "codexAuth.autoSwitchDesc": "Auf einem Anfragepfad: wechselt ab {threshold} % Auslastung, wenn ein verfügbares Konto niedriger ausgelastet ist (keine parallelen Sitzungen); Go/Free nutzen nur das 30-Tage-Fenster",
  ...
  "api.authLoopback": "Lokaler Host 127.0.0.1 / localhost bei Loopback-Bind umgeht die Authentifizierung. Öffentliche Host-Header (Tunnel wie ngrok) und Nicht-Loopback-Binds benötigen einen generierten ocx_-Schlüssel oder OPENCODEX_API_AUTH_TOKEN.",
  "api.authTunnelNgrok": "Bei ngrok Free sollten API-Clients zusätzlich ngrok-skip-browser-warning: 1 senden, um die Browser-Zwischenseite zu überspringen.",
  ...
  "api.testAll": "Alle testen",
  "api.testingAll": "Teste {done}/{total}…",
  ...
  "claude.ideHint": "Cursor IDE Claude Code Chat: einmal {cmd} ausführen, dann das Claude-Panel neu laden.",
  "claude.failoverDefault": "Failover-Default",
  "claude.failoverDefaultDesc": "Ersetzt Claude Default/Opus durch den rangierten Gateway-Kettenkopf. Wechselt nur bei Fehlern, nicht bei jedem 200.",
  "claude.failoverDefaultApply": "Rangiertes Default anwenden",
  "claude.failoverDefaultOk": "Failover-Default angewendet. Claude-Panel neu laden.",
  "claude.failoverDefaultOkAlias": "Failover-Default angewendet → {alias}. Claude-Panel neu laden.",
  "claude.failoverDefaultFail": "Failover-Default konnte nicht angewendet werden.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "codexAuth.quotaWarning": "Kontingentwarnung",
  "codexAuth.quotaCritical": "Kontingent kritisch",
  "codexAuth.quotaUrgent": "Dringende Kontingentwiederherstellung",
  "codexAuth.quotaExhausted": "Kontingent aufgebraucht",
  "codexAuth.quotaStale": "Kontingentdaten sind veraltet. Vor der Kontoauswahl aktualisieren.",
  "codexAuth.quotaReset": "Zurückgesetzt {when}",
  "codexAuth.recoveryPickerTitle": "Konto für eine neue Sitzung auswählen",
  "codexAuth.recoverySwitch": "Konto wechseln",
  "codexAuth.recoveryNewSession": "Bestehende Threads bleiben an dieses Konto gebunden. Der Wechsel startet oder verwendet eine neue Sitzung.",
  "codexAuth.recoveryLogin": "Weiteres Konto anmelden",
  "codexAuth.recoverySwitchFailed": "Konten konnten nicht gewechselt werden. Erneut versuchen.",
  "codexAuth.recoveryRefresh": "Kontingente aktualisieren",
  "codexAuth.recoveryAutoSwitch": "Automatischer Wechsel ist für neue Sitzungen verfügbar",
  "codexAuth.recoveryAutoSwitchOff": "Automatischer Wechsel ist aus; Konto für eine neue Sitzung auswählen.",
  "codexAuth.recoveryWait": "Auf das Zurücksetzen dieses Kontingentfensters warten.",
  "codexAuth.recoveryReauth": "Erneute Anmeldung erforderlich",
  "codexAuth.recoveryUnknown": "Kontingentstatus nicht verfügbar",
  "codexAuth.recoveryDisabled": "Dieses Konto kann derzeit nicht ausgewählt werden.",
  "codexAuth.recoveryReady": "Bereit für eine neue Sitzung.",
  "codexAuth.recoveryUsage": "{window}-Kontingent ist zu {percent}% verbraucht.",
  "codexAuth.recoveryNextAction": "Für eine neue Sitzung ein anderes Konto auswählen.",
};
