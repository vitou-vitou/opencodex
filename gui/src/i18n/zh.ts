...
export const zh: Record<TKey, string> = {
  ...
  "logs.filter.noMatches": "没有符合这些筛选条件的请求。",
  ...
  "api.authLoopback": "回环绑定时，本地 Host 127.0.0.1 / localhost 会跳过身份验证。公网 Host（如 ngrok 隧道）以及非回环绑定需要生成的 ocx_ 密钥或 OPENCODEX_API_AUTH_TOKEN。",
  "api.authTunnelNgrok": "使用 ngrok 免费版时，API 客户端还应发送 ngrok-skip-browser-warning: 1 以跳过浏览器提示页。",
  ...
  "claude.ideHint": "Cursor IDE 中的 Claude Code 聊天：运行一次 {cmd}，然后重新加载 Claude 面板。",
  "claude.failoverDefault": "故障转移默认",
  "claude.failoverDefaultDesc": "将 Claude Default/Opus 换成排名网关链首。仅在失败时跳转，不会在每次 200 时轮换。",
  "claude.failoverDefaultApply": "应用排名默认",
  "claude.failoverDefaultOk": "已应用故障转移默认。请重新加载 Claude 面板。",
  "claude.failoverDefaultOkAlias": "已应用故障转移默认 → {alias}。请重新加载 Claude 面板。",
  "claude.failoverDefaultFail": "无法应用故障转移默认。",
