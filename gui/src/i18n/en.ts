...
export const en = {
  ...
  "prov.openaiPoolDesc": "Default. One Codex request path: rotate the main login and added accounts using thread affinity, quota, cooldown, and failover — not N parallel sessions.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "codexAuth.autoSwitchDesc": "On one request path, switches at {threshold}% usage or above when an eligible account has lower usage (not parallel sessions); Go/Free use 30d only",
