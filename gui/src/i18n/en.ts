...
export const en = {
  ...
  "logs.filter.noMatches": "No requests match these filters.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "api.authLoopback": "Local Host 127.0.0.1 / localhost on a loopback bind bypasses authentication. Public Host headers (tunnels such as ngrok) and non-loopback binds require a generated ocx_ key or OPENCODEX_API_AUTH_TOKEN.",
  "api.authTunnelNgrok": "On ngrok free, API clients should also send ngrok-skip-browser-warning: 1 to skip the browser interstitial.",
  ...
  "claude.ideHint": "Cursor IDE Claude Code chat: run {cmd} once, then reload the Claude panel.",
  "claude.failoverDefault": "Failover Default",
  "claude.failoverDefaultDesc": "Replace Claude Default/Opus with the ranked gateway chain head. Hops on failure only, not every 200.",
  "claude.failoverDefaultApply": "Apply ranked Default",
  "claude.failoverDefaultOk": "Failover Default applied. Reload the Claude Code panel.",
  "claude.failoverDefaultOkAlias": "Failover Default applied → {alias}. Reload the Claude Code panel.",
  "claude.failoverDefaultFail": "Could not apply Failover Default.",
