...
concurrent agent). Parallel fleets need separate agents and accounts outside this routing. For the
same distinction versus peer tools, see [Compare Proxies](/guides/compare-proxies/).
:::
